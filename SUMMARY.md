...
* [Novo Canvas (Beta restrito)](build/novo-canvas-beta-restrito/README.md)
  * [Navegação em um pipeline (Beta restrito)](build/novo-canvas-beta-restrito/navegacao-em-um-pipeline-beta-restrito.md)
...
* [Novo Controle de Acesso](administration/novo-controle-de-acesso/README.md)
  ...
  * [Fluxo de login](administration/novo-controle-de-acesso/fluxo-de-login.md)
...
* [Triggers](components/triggers/README.md)
  ...
  * [Configurações de Triggers](components/triggers/configuracoes-de-triggers/README.md)
    * [Nova interface de configuração e rotas personalizáveis](components/triggers/configuracoes-de-triggers/nova-interface-de-configuracao-e-rotas-personalizaveis/README.md)
      * [Configuração Global de CORS](components/triggers/configuracoes-de-triggers/nova-interface-de-configuracao-e-rotas-personalizaveis/configuracao-global-de-cors.md)
