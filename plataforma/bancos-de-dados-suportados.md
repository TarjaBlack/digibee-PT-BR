...
**IMPORTANTE:** a Plataforma Digibee desabilita a interpretação de _strings_ Maria DB pelo _driver_ Mysql. No entanto, é possível utilizar o _driver_ Maria DB para se conectar a versões mais antigas do Mysql.
...
**IMPORTANTE:** a Plataforma Digibee desabilita a interpretação de _strings_ Maria DB pelo _driver_ Mysql.
