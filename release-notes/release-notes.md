...
Serviço - identificação da funcionalidade da plataforma Digibee que foi auditada. Ex.: pipelines, globals, accounts.
...
O digibeectl é o CLI (command-line interface) da Digibee que permite a execução de uma série de passos relacionados aos serviços disponíveis na plataforma Digibee HIP, até então somente disponíveis através da interface gráfica. Para saber mais sobre o digibeectl e sua documentação [clique](https://intercom.help/godigibee/pt-BR/articles/5214735-guia-de-uso-do-digibeectl).\
\
...
Pensando facilitar cada vez mais o seu dia-a-dia com a Plataforma Digibee, estamos disponibilizando Cápsulas prontas para utilização.
...
O que estamos entregando para melhorar a sua experiência com a Plataforma Digibee.
...
Disponibilizamos um novo componente que torna possíveis chamadas gRPC através da Plataforma Digibee. Com isso você pode executar chamadas do tipo _unary_ e _client stream_. Leia o artigo sobre o componente _gRPC_ clicando [aqui](https://intercom.help/godigibee/pt-BR/articles/5222262-grpc).
...
Para que você se familiarize melhor com os termos e conceitos relacionados à navegação da Plataforma Digibee, vamos lançar uma série de artigos esclarecedores.
