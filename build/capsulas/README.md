...
Para utilizar a Cápsula dentro da Digibee Integration Platform, basta acessá-la a partir do menu principal, clicar no botão CRIAR para criar uma nova Cápsula e assim construir uma lógica com a já conhecida interface da Digibee Integration Platform.
